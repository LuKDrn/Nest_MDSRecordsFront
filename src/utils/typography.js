// J'ai repris de template sur un projet typography pour la page 404 :  GitHub https://github.com/gatsbyjs/gatsby/blob/master/examples/using-typescript/src/utils/typography.js
